...
@registry.register_agent("ScaffoldAgent")
class ScaffoldAgent(BaseAgent):
    ...
    def run(self, file):
        ...
        conversation = self._scaffold_conversation(file, width, height)
    ...
    def _scaffold_conversation(self, file, width, height):
        ...
        conversation = [
            {
                ...
                "content": [
                    ...
                    {"type": "image", "image_url": file.replace("ori", "ori_dots").replace(".pdf", ".png")},
                ],
            }
        ]
        return conversation
